  ...
  <div class="wrap">
    ...
    <div class="cols">
      <div class="col"><div class="rule"></div>
        ...
        <p>A second copy took a long time to build, so the cost of having one surfaced long after
           the decision that caused it, and landed on whoever was there when it did.</p></div>
      <div class="col"><div class="rule"></div>
        <h3>Now it is an afternoon</h3>
    ...
    <p class="note"><b>Whether that matters to you is a real question and it has an honest
       ...
       problem, and adopting AI without a view of the whole system is how the bill gets larger
...
<section>
  <div class="wrap">
    ...
    <div class="vert">
      <b>What it buys</b>
      <p>Concretely: you find the same rule implemented at the API layer more than once. The team
         that owns that boundary owns removing it, over time, as work passes through. That is what
         turns a system view into velocity rather than a diagram, and it is the only thing that
